...
export function useArchetypes() {
  ...
  const [expandedArchetypeId, setExpandedArchetypeId] = useState<number | null>(
    null
  );
  ...
  const archetypes: Archetype[] = [
    {
      ...
      name: 'Labor Staffing',
      description:
        'Combines staffing schedules and patient census data for labor analysis',
      status: 'Running...',
    ...
    },
    {
      ...
      description:
        'Tracks supply usage and procurement records for inventory reporting',
      status: 'Running...',
      statusColor: 'bg-green-500',
      tablesCount: 8,
    ...
    },
    {
      ...
      description:
        'Links schedules and procedure logs to analyze operating room use',
      status: 'Paused',
    ...
    },
    {
      ...
      name: 'Referral Data',
      description:
        'Aggregates referral and follow-up data to track care coordination',
      status: 'Running...',
      statusColor: 'bg-green-500',
      tablesCount: 5,
    ...
    },
    {
      ...
      description:
        'Connects admission, discharge, and bed data to support throughput',
      status: 'Running...',
      statusColor: 'bg-green-500',
      tablesCount: 22,

...
export function CalendarHeatmap({
  data,
  colorScale = ['#e6f7ff', '#bae7ff', '#91d5ff', '#69c0ff', '#40a9ff', '#1890ff', '#096dd9', '#0050b3', '#003a8c', '#002766'],
  height = 200,
  width = '100%'
            ...
            <div className="flex flex-1">
              {months.map((_, monthIndex) => {
                ...
                const matchingData = data.find(d => {
                  ...
                  return date.getDay() === dayIndex && date.getMonth() === monthIndex;
                });
                ...
                return (
                  <div 
                    ...
                    title={matchingData ? `${matchingData.date}: ${matchingData.value}` : 'No data'}
                  />
                );
              })}
            </div>

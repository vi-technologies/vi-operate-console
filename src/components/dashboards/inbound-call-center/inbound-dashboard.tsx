    ...
    <>
      ...
      <div className="mt-4">
        ...
        <Card className="mb-6">
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-lg font-medium">Monthly Call Volume by Type</CardTitle>
          ...
          <CardContent>
            <LineChart
              data={callVolumeData}
              lines={[
                { dataKey: 'General', stroke: '#1890ff', name: 'General Inquiries' },
                { dataKey: 'Appointment', stroke: '#52c41a', name: 'Appointment Scheduling' },
                { dataKey: 'Technical', stroke: '#fa8c16', name: 'Technical Support' },
                { dataKey: 'Billing', stroke: '#f5222d', name: 'Billing Questions' }
              ]}
              height={300}
            />
          </CardContent>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-lg font-medium">Staffing Requirements</CardTitle>
            ...
            <CardContent>
              <LineChart
                ...
                lines={[
                  { dataKey: 'Current', stroke: '#8884d8', name: 'Current Staff' },
                  { dataKey: 'Projected', stroke: '#f5222d', name: 'Projected Need' }
                ]}
                height={280}
              />
              <div className="mt-4 text-sm">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <span className="text-xs text-muted-foreground">Current FTEs</span>
                  ...
                  <div>
                    ...
                    <div className="text-lg font-medium flex items-center">
                      48 agents <span className="text-red-500 text-sm ml-2">(+50%)</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <BarChart
                ...
                bars={[
                  { dataKey: 'General', fill: '#1890ff', name: 'General Inquiries' },
                  { dataKey: 'Appointment', fill: '#52c41a', name: 'Appointment Scheduling' },
                  { dataKey: 'Technical', fill: '#fa8c16', name: 'Technical Support' },
                  { dataKey: 'Billing', fill: '#f5222d', name: 'Billing Questions' }
                ]}
                stackId="stack"
                height={280}
              />
              <div className="mt-4 text-sm">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <span className="text-xs text-muted-foreground">Highest Call Volume Quarter</span>
                    <div className="text-lg font-medium">Q3 (Jul-Sep)</div>
                  </div>
                  <div>
                    <span className="text-xs text-muted-foreground">Total Annual Calls</span>
      ...
      <div className="mt-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-lg font-medium">Historical Inbound Call Trends</CardTitle>
              <LineChartIcon className="h-5 w-5 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <ScatterChart
              ...
              <div className="mt-4 text-sm">
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div>
                    <span className="text-xs text-muted-foreground">Weekday Avg</span>
                    <div className="text-base font-medium">105 calls/hr</div>
                  </div>
                  <div>
                    <span className="text-xs text-muted-foreground">Weekend Avg</span>
          ...
          <Card>
            ...
            <CardContent>
              <BarChart
                data={weekDemand}
                bars={[
                  { dataKey: 'Call Volume', fill: '#1890ff' }
                ]}
                height={280}
              />
              <div className="mt-4 text-sm">
                <div className="flex justify-between gap-2">
                  ...
                  <div>
                    <span className="text-xs text-muted-foreground">Slowest Day</span>
                    <div className="text-base font-medium">Sunday</div>
                  </div>
                  <Button variant="link" size="sm" className="text-sm flex items-center">
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <CalendarHeatmap
              data={calendarData}
              colorScale={['#e6f7ff', '#bae7ff', '#91d5ff', '#69c0ff', '#40a9ff', '#1890ff', '#096dd9']}
              height={230}
            />
            <div className="mt-4 text-sm flex justify-between">
              <div>
                <span className="text-xs text-muted-foreground">Seasonal Pattern</span>
                <div className="text-base font-medium">Summer peak with December holiday spike</div>
              </div>

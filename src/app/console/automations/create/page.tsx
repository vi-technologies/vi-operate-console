...
export default function AutomationCreatePage() {
  ...
  return (
    <Page title="Create New Automation" variant="splash">
      <BackgroundComponent>
        <div className="flex flex-col min-h-[80vh]">
          {/* Main creation form */}
          <Card className="flex-1 flex flex-col p-8 relative border shadow-none rounded-none max-w-5xl mx-auto w-full">
